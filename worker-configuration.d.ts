/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 32c0a478fe6db9618cab1eba1d823ed5)
// Runtime types generated with workerd@1.20260426.1 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		WHATSAPP_ALERTS_QUEUE: Queue;
		DEFAULT_GENERATOR_ID: "1";
		WHATSAPP_ALERTS_ENABLED: "1";
		ALERT_WHATSAPP_TO: "whatsapp:+573167821687";
		TWILIO_ACCOUNT_SID: string;
		TWILIO_AUTH_TOKEN: string;
		TWILIO_WHATSAPP_FROM: string;
		NOTIFICATION_HUB: DurableObjectNamespace<import("./src/worker/index").NotificationHub>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_GENERATOR_ID" | "WHATSAPP_ALERTS_ENABLED" | "ALERT_WHATSAPP_TO" | "TWILIO_ACCOUNT_SID" | "TWILIO_AUTH_TOKEN" | "TWILIO_WHATSAPP_FROM">> {}
}
